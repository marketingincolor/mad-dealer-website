<?php
/**
 * Template Name: Dealer Signup
 *
 * @package     : WordPress
 * @subpackage  : Twenty_Fifteen
 * @Description : The template for displaying the Dealer Signup Form
...
if(isset($_POST['save'])){
    ...
    $other = $_POST['Other'];
    $dealertype = array($automotive,$architectural,$safetySecurity,$other);
    $dealertypeFilter = array_filter($dealertype);
    $dealertypeResult = implode(', ', $dealertypeFilter);
    $comments = $_POST['Comments'];

    $subject = 'Dealer Directory Contact Form Submission';
    ...
    $message = "<html><head></head>"
            ...
            . "<td style='border: 1px solid #e3e3e3;padding: 7px 9px;background: #fff;text-align: left;font-size: 13px;'>".$dealertypeResult."</td>"
            . "</tr>"
            . "<tr>"
...
<div class="contact-us-container">
    <div class="container">
        <div class="contact-us-blk-container">
            <h2 class="md-title">Be searchable!</h2>
            <hr>
            <p>The Madico Dealer Directory allows you, as a Madico dealer, to have a unique online page branded with your contact information, company logo, website address, and social media profiles.  It also contains a lead capture form that sends your prospect's information directly to the email address you provide. Plus, social media tools allow visitors to share your page and contact information on Facebook, Twitter, LinkedIn and/or Google+ providing you the opportunity to reach even more prospects!</p>
            <p>Complete the form below with your information to be included in our Dealer Directory.</p>
        </div>
        ...
        <div class="contact-us-form">
            <form role="form" method="post" id="dealersignupPage">
                <input type="hidden" name="form_title" value="DealerSignup"/>
                ...
                <div class="col-md-12 form-check-blk" id="productsList">
                    <div class="row">
                        ...
                        <div class="checkbox" >
                            <input type="hidden" name="dealertype" id="dealertype"/>
